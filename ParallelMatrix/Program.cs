...
int[,] serialMulRes = new int[N, N]; //результат выполнения умнржения матриц в однопоптоке
...
{
    if (a.GetLength(1) != b.GetLength(0)) throw new Exception ("Нельзя умножит такие матрицы");
